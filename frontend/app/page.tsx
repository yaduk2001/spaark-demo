      ...
      <section className="py-20 px-6 bg-zinc-950 relative z-10 border-t border-white/5 pattern-circuit">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card-angular p-8 flex flex-col hover:-translate-y-2 transition-all duration-300 gold-glow relative group overflow-hidden" style={{ background: "rgba(5,5,5,0.4)", backdropFilter: "blur(8px)" }}>
              <div className="absolute inset-0 z-0">
                <Image
                  ...
                  style={{ filter: "brightness(1.2) contrast(1.15) saturate(1.2)" }}
                />
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-xl font-bold text-white uppercase italic mb-4 drop-shadow-[0_2px_6px_rgba(0,0,0,1)]">Dubai Headquarters United Arab Emirates</h3>
                <p className="text-zinc-100 font-medium leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,1)] mt-auto">Strategic positioning in the world's leading blockchain and digital asset hub, providing access to progressive regulatory frameworks and international markets.</p>
              </div>
            </div>
            ...
            <div className="card-angular p-8 flex flex-col hover:-translate-y-2 transition-all duration-300 gold-glow relative group overflow-hidden" style={{ background: "rgba(5,5,5,0.4)", backdropFilter: "blur(8px)" }}>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-xl font-bold text-white uppercase italic mb-4 drop-shadow-[0_2px_6px_rgba(0,0,0,1)]">Australia Registry Commonwealth of Australia.</h3>
                <p className="text-zinc-100 font-medium leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,1)] mt-auto">Registered entity benefiting from Australia's robust financial regulatory environment and FinTech innovation ecosystem.</p>
              </div>
            </div>
            ...
            <div className="card-angular p-8 flex flex-col hover:-translate-y-2 transition-all duration-300 gold-glow relative group overflow-hidden" style={{ background: "rgba(5,5,5,0.4)", backdropFilter: "blur(8px)" }}>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <h3 className="text-xl font-bold text-white uppercase italic mb-4 drop-shadow-[0_2px_6px_rgba(0,0,0,1)]">United States of America.</h3>
                <p className="text-zinc-100 font-medium leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,1)] mt-auto">Positioned within a premier global hub for technological advancement and venture capital, fostering high-level institutional partnerships and large-scale growth.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-zinc-900/40 relative z-10 pattern-overlay">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="card-angular hover:border-[#D4AF37]/50 transition-all duration-300 p-[2px] gold-glow overflow-visible relative group">
                <FuturePlanCard step="2029" title="Official Launch of Spaark Online Market Hub" description="Introduction of a Global Online Market Hub enabling Digital Commerce, Services, and Entrepreneurial participation through Spaark-powered platform." image="/images/IMG_20260303_215228.png" isReversed={true} imageFit="contain" />
            ...
            <div className="max-w-4xl mx-auto">
              <div className="card-angular hover:border-[#D4AF37]/50 transition-all duration-300 p-[2px] gold-glow overflow-visible relative group">
                <FuturePlanCard step="2034" title="Official Launch of Spaark E-commerce Shoppi" description={`"Where Technology meets trust" — While others sell products, Spaark Ecommerce builds Shopping experience for the future.`} image="/images/IMG_20260303_213017.png" isReversed={true} imageFit="contain" />
                <div className="absolute inset-x-0 inset-y-0 pointer-events-none rounded-xl" style={{ backdropFilter: "contrast(1.2) brightness(1.1) saturate(1.2) sepia(0.05)", clipPath: "polygon(0 0, 50% 0, 50% 100%, 0 100%)" }} />
              </div>
            </div>
            <div className="max-w-4xl mx-auto">
